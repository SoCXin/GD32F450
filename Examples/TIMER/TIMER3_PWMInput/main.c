/**
  ******************************************************************************
  * @file    TIMER/TIMER3_PWMInput/main.c
  * @author  MCU SD
  * @version V2.0.0
  * @date    15-Jan-2016
  * @brief   Main program.
...
void GPIO_Configuration(void)
{
    ...
    /*Configure PB4 PB5 (TIMER3 CH1 CH2) as alternate function*/
...
void TIMER_Configuration(void)
{
 /* TIMER3 configuration: PWM Input mode ------------------------
  ...
  ------------------------------------------------------------ */
    ...
    TIMER_PWMCaptureConfig(TIMER3,&TIMER_ICInitStructure);

    /* Slave Mode selection: TIMER3 */
    TIMER_SelectInputTrigger(TIMER3,TIMER_TS_TI1FP1);
